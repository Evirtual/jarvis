 ...
 *
 * `SpeechSynthesis` ships in TypeScript's DOM lib but `SpeechRecognition` does
 * not — it is still prefixed and unshipped in several browsers. These are the
 * parts the console actually uses.
 */
